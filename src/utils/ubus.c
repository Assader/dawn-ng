...
typedef struct {
    ...
    /* neighbor report string
     * [Elemen ID|1][LENGTH|1][BSSID|6][BSSID INFORMATION|4]
     * [Operating Class|1][Channel Number|1][PHY Type|1][Operational Subelements]
     */
...
/* RRM is for Radio Resource Measurement. */
enum {
    RRM_ARRAY,
    __RRM_MAX,
};
